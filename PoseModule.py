...
class poseDetector():
    def __init__(self, mode=False, Complex=1, UpBody=False, Smooth=True, Segment=True,
        ...
        self.pose = self.mpPose.Pose(self.mode, self.Complex, self.UpBody, self.Smooth, self.Segment,
                                     self.smoothSeg, self.detectionCon, self.trackingCon)
